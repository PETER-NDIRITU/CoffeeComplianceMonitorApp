...
def load_kenyan_counties():
    return gpd.read_file(
        "Datasets/Counties/Counties.shp")
...
def load_croplands():
    return gpd.read_file(
        "Datasets/EUDR_Coffee_Farms/All_Coffee_Farms.shp"
    )
...
Effective from December 31, 2025, these regulations require the collection and verification of geographic coordinates to confirm that commodities are not sourced from deforested areas. """)
